        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-slate-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-blue-600">智能分析器</span>
            </h1>
          ...
          {navigationCards.map((card) => {
            ...
            return (
              <Link
                key={card.id}
                to={card.path}
                className={`${card.bgColor} border border-slate-200 rounded-xl p-8 transition-all duration-200 hover:shadow-lg hover:scale-105 group`}
              >
                <div className="flex items-center mb-4">
                  <div className={`${card.color} p-3 rounded-lg bg-white shadow-sm group-hover:shadow-md transition-shadow`}>
                    <IconComponent className="h-8 w-8" />
                  </div>
                  <h3 className="ml-4 text-xl font-bold text-slate-900">
                    {card.title}
                  </h3>
                </div>
